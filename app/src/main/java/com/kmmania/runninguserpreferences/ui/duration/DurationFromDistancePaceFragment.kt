 ...
 * Use the [DurationFromDistancePaceFragment.newInstance] factory method to
...
class DurationFromDistancePaceFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment DurationFromDistancePaceFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            DurationFromDistancePaceFragment().apply {
