 ...
 * Use the [DurationFromDistanceSpeedFragment.newInstance] factory method to
...
class DurationFromDistanceSpeedFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment DurationFromDistanceSpeedFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            DurationFromDistanceSpeedFragment().apply {
